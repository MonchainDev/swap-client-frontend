...
```bash
$ pnpm add @monswap/multicall @monswap/sdk viem
```
...
import { multicallByGasLimit, MulticallRequestWithGas } from '@monswap/multicall'
...
```typescript
import { ChainId } from '@monswap/chains'
import { getGasLimitOnChain } from '@monswap/multicall'
...
For supported chains and contract addresses, please refer to [multicall contracts](https://github.com/monswap/pancake-frontend/blob/develop/packages/multicall/src/constants/contracts.ts).
