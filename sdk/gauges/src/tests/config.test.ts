import { ChainId, chainNames } from '@monswap/chains'
import { FACTORY_ADDRESS_MAP, Token, computePairAddress } from '@monswap/sdk'
import { DEPLOYER_ADDRESSES, computePoolAddress } from '@monswap/v3-sdk'
