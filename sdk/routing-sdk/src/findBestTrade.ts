import { formatFraction } from '@monswap/utils/formatFractions'
import { Token, Currency, CurrencyAmount, Fraction, TradeType } from '@monswap/swap-sdk-core'
...
async function getBestTrade({
  ...
  console.info('[getBestTrade] candidatePools: ', candidatePools)
  const graph = graphOverride || createGraph({ pools: candidatePools })
  console.info('[getBestTrade] graph: ', graph)
