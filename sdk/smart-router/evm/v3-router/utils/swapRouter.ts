...
import { Currency, CurrencyAmount, Percent, TradeType, validateAndParseAddress, WNATIVE } from '@monswap/sdk'
import { ChainId } from '@monswap/chains'
import { FeeOptions, MethodParameters, Payments, PermitOptions, Position, SelfPermit, toHex } from '@monswap/v3-sdk'
...
/**
 * Represents the monswap V2 + V3 + StableSwap SwapRouter02, and has static methods for helping execute trades.
 */
