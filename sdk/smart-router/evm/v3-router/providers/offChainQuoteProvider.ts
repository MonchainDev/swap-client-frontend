import { Currency, CurrencyAmount, Pair, ZERO } from '@monswap/sdk'
import { Pool as V3Pool, TickList } from '@monswap/v3-sdk'
import { getQuoteExactIn, getQuoteExactOut } from '@monswap/stable-swap-sdk'
import {
  Pool as IPool,
  Pool,
  QuoteProvider,
