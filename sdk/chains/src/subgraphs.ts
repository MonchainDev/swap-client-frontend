...
export function getV3Subgraphs({ noderealApiKey, theGraphApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.GOERLI]: 'https://api.thegraph.com/subgraphs/name/monswap/exchange-v3-goerli',
    ...
    [ChainId.LINEA_TESTNET]:
      'https://thegraph.goerli.zkevm.consensys.net/subgraphs/name/monswap/exchange-v3-linea-goerli',
    ...
    [ChainId.OPBNB]: `https://open-platform-ap.nodereal.io/${noderealApiKey}/opbnb-mainnet-graph-query/subgraphs/name/monswap/exchange-v3`,
...
export function getV2Subgraphs({ noderealApiKey, theGraphApiKey }: SubgraphParams) {
  return {
    ...
    [ChainId.LINEA_TESTNET]: 'https://thegraph.goerli.zkevm.consensys.net/subgraphs/name/monswap/exhange-eth/',
    ...
    [ChainId.OPBNB]: `https://open-platform-ap.nodereal.io/${noderealApiKey}/opbnb-mainnet-graph-query/subgraphs/name/monswap/exchange-v2`,
  }
}

export function getBlocksSubgraphs({ noderealApiKey }: SubgraphParams) {
  return {
    [ChainId.BSC]: 'https://api.thegraph.com/subgraphs/name/monswap/blocks',
    ...
    [ChainId.OPBNB]: `https://open-platform-ap.nodereal.io/${noderealApiKey}/opbnb-mainnet-graph-query/subgraphs/name/monswap/blocks`,
  } as const
}
