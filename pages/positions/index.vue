      ...
      <ElTableColumn label="Pool" width="320">
        <template #default="{ row }">
          <div class="flex items-center gap-2">
            ...
            <span class="text-secondary rounded bg-surface px-[6px] py-[2px] text-xs font-medium lowercase">{{ row.protocolVersion }}</span>
            <span class="text-secondary rounded bg-surface px-[6px] py-[2px] text-xs font-medium lowercase">{{ row.feeTier / 10000 }}%</span>
          </div>
        </template>
      </ElTableColumn>
