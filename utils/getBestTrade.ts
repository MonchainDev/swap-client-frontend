...
import { PoolType, type Route, type SmartRouterTrade, type V3Pool } from '@wicchain/smart-router'
import { CurrencyAmount, Token, TradeType, type Currency } from '@wicchain/swap-sdk-core'
import { TICK_SPACINGS, TickMath, type FeeAmount } from '@wicchain/v3-sdk'
