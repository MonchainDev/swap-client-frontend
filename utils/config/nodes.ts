...
import { getNodeRealUrl } from '../node/nodeReal'
import { getGroveUrl } from '../node/pokt'
import { notEmpty } from '../notEmpty'

const ARBITRUM_NODES = [...arbitrum.rpcUrls.default.http, 'https://arbitrum-one.publicnode.com', 'https://arbitrum.llamarpc.com'].filter(notEmpty)
...
export const SERVER_NODES = {
  ...
  [ChainId.GOERLI]: [getNodeRealUrl(ChainId.GOERLI, process.env.SERVER_NODE_REAL_API_GOERLI) || '', 'https://eth-goerli.public.blastapi.io'].filter(notEmpty),
  ...
  [ChainId.POLYGON_ZKEVM_TESTNET]: ['https://polygon-zkevm-testnet.rpc.thirdweb.com', ...polygonZkEvmTestnet.rpcUrls.default.http],
  [ChainId.ZKSYNC]: [...zkSync.rpcUrls.default.http, getNodeRealUrl(ChainId.ZKSYNC, process.env.SERVER_NODE_REAL_API_ETH) || ''],
  ...
  [ChainId.OPBNB]: [...opBNB.rpcUrls.default.http, getNodeRealUrl(ChainId.OPBNB, process.env.SERVER_NODE_REAL_API_ETH) || ''],
  [ChainId.BASE]: [
...
export const PUBLIC_NODES: Record<ChainId, string[] | readonly string[]> = {
  ...
  [ChainId.GOERLI]: [getNodeRealUrl(ChainId.GOERLI, process.env.NEXT_PUBLIC_NODE_REAL_API_GOERLI) || '', 'https://eth-goerli.public.blastapi.io'].filter(
    notEmpty
  ),
  ...
  [ChainId.POLYGON_ZKEVM_TESTNET]: [...polygonZkEvmTestnet.rpcUrls.default.http, 'https://polygon-zkevm-testnet.rpc.thirdweb.com'],
  [ChainId.ZKSYNC]: [
