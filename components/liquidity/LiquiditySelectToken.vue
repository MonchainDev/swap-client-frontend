<template>
  <div class="flex h-[55px] cursor-pointer items-center gap-[10px] rounded-lg bg-[#F3F8FF] px-8 sm:px-4" @click="emit('selectToken')">
    ...
    <template v-else>
      ...
      <div class="flex items-center gap-1 text-gray-6">
        <span class="text-sm sm:text-xs">Select a token</span>
